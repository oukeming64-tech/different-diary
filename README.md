...
[在线体验](https://jianfei-paipai-le.kemo64.chatgpt.site/) · [查看贡献说明](CONTRIBUTING.md) · [报告安全问题](SECURITY.md)
...
1. 打开[在线版本](https://jianfei-paipai-le.kemo64.chatgpt.site/)，从首页挑一句最接近当前状态的话。
